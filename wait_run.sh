...
#pintos -v -k --fs-disk=2 --qemu -p ../../examples/longrun_interactive -a interactive -p ../../examples/generic_parent -a generic_parent -p ../../examples/busy -a dummy -- -f -q run 'interactive 4 4 '
